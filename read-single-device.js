module.exports = function(RED) {
  ...
  function ReadSingleDevice(config) {
      ...
      node.on('input', function(msg) {
        ...
        if(msg.address == "" || msg.address == null){
          ...
          if(msg.getAllPropertiesManually == "true"){
            ...
            parseDeviceObject(address, result, {type: 8, instance: deviceId}, false, res => printResultObjectSingleDevice(deviceId, res));
          ...
          if(msg.getAllPropertiesManually == "false"){
            ...
            bacnetClient.readPropertyMultiple(address, requestArray, (err, value) => {
              ...
              parseDeviceObject(address, value, {type: 8, instance: deviceId}, true, res => printResultObjectSingleDevice(deviceId, res));
          ...
          */
          ...
          function printResultObjectSingleDevice(deviceId, obj) {
            objectsDone++;
  ...
  RED.nodes.registerType("read-single-device",ReadSingleDevice);
